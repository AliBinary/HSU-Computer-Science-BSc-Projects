...
namespace hakimApp.Data.Contracts
{
    public interface IRepository<T>
    {
        ...
        Task<QueryResult<T>> ExecuteQueryAsync(string query, DynamicParameters parameters, bool skipPageInation = false, int pageNO = 0, int seedNO = 10, bool injectUserId = false, int userId = 0, bool injectLang = false, int lang = 0);
