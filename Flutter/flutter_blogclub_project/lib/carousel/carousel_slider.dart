    ...
    Key? key,
       ...
       _carouselController =
           carouselController != null
               ? carouselController
                   as CarouselSliderControllerImpl
...
class CarouselSliderState extends State<CarouselSlider>
  ...
  CarouselPageChangedReason mode =
  ...
  Timer? getTimer() {
    return widget.options.autoPlay
        ? Timer.periodic(widget.options.autoPlayInterval, (
          _,
        ) {
          if (!mounted) {
            clearTimer();
          ...
          int nextPage =
              carouselState!.pageController!.page!.round() +
              1;
          int itemCount =
          ...
          return AnimatedBuilder(
            ...
            builder: (BuildContext context, child) {
              ...
              if (widget.options.enlargeCenterPage !=
                      null &&
                  widget.options.enlargeCenterPage ==
                      true) {
                // pageController.page can only be accessed after the first build,
                // so in the first build we calculate the itemoffset manually
                var position =
                    carouselState?.pageController?.position;
                if (position != null &&
                    position.hasPixels &&
                  ...
                  if (previousSavedPosition != null) {
                    ...
                    itemOffset =
                        carouselState!.realPage.toDouble() -
                        idx.toDouble();
                  }
                }
                ...
                final double enlargeFactor = options
                    .enlargeFactor
                    .clamp(0.0, 1.0);
                final num distortionRatio = (1 -
                        (itemOffset.abs() * enlargeFactor))
                    .clamp(0.0, 1.0);
              ...
              if (widget.options.scrollDirection ==
                  Axis.horizontal) {
...
class _MultipleGestureRecognizer
